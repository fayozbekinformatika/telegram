...
export const LoginScreen: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0e1621] text-white flex items-center justify-center p-4">
      <div className="bg-[#17212b] max-w-md w-full rounded-2xl p-8 shadow-2xl flex flex-col items-center text-center animate-in fade-in zoom-in-95 duration-300">
        ...
        <button
          onClick={handleLogin}
          disabled={isLoading}
          className="w-full bg-white text-slate-900 font-medium py-3 px-4 rounded-xl flex items-center justify-center gap-3 hover:bg-gray-100 transition-colors disabled:opacity-70"
        >
          {isLoading ? (
